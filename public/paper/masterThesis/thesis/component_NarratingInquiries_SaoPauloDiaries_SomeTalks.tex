...
\reference[narratinginquiries_saopaulodiaries_minifeira]{}People of the \aKeyword[MST]{streets+actors+movements+mst}\aKeywordInVi{mst} \toTranslate[assentamento]{settlement} \aKeyword[Irmã Alberta]{streets+places+settlements+irmã alberta}\aKeywordInVi{mst+settlement+irmã alberta}, located in Peŕus at the fringes of the city of São Paulo, started to establish an \aKeyword[mini-feira]{streets+actions+mini-feira}\toTranslateT{mini-feira}{mini market} during vegan lunch \aLinkNewF{http://www.mst.org.br/node/10157}. 
