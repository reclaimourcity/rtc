...
\reference[methodology_whoami_actionresearch_knowledge]{}By gaining a more comprehensive idea of \abbr{AR} I am also concretely confronted for the first time with the question \quote{How is knowledge created and disseminated}, a question asked in the study of knowledge, the so called \aKeyMarVi{Epistemology} \aLinkNewF{http://plato.stanford.edu/entries/epistemology/} \footnote{In German: Erkenntnisstheorie}. I also want to dedicate some room for this question and its effects on the thesis knowledge production.
