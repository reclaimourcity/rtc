...
\reference[methodology_whoami_actionresearch_knowledge]{}By gaining a more comprehensive idea of \abbr{AR} I am also concretely confronted for the first time with the question \quote{How is knowledge created and disseminated}, a question asked in the studies of knowledge, the so called \aKeyMarVi{Epistemology} \aLinkNewF{http://plato.stanford.edu/entries/epistemology/} \footnote{In German: Erkenntnisstheorie}. I also want to dedicate some room for this question and its effects on the thesis knowledge production.
...
\reference[methodology_whoami_socialmovements]{}I refer here to social movements as collectives or groups of marginalized people \footnote
{
...
\reference[methodology_whoami_actionresearch_notionsoftheorizing]{}Different notions of theorizing, knowledge and content can be distinguished here, notions that are \aKeyword[relevant]{research+relevance} for this thesis research \bracket{there are much more notions not considered here} which is grounded on actions conducted in a social world:
...
In short, the five main \aKeyMarVi[tendencies]{tendencies in AR} \inright{tendencies of \abbrFull{AR} is aiming for} that she distinguishes as aims of \abbrFull{AR} are...
...
\reference[methodology_whoami_actionresearch_genuineparticipation]{}So to say, our collaboration and participation allowed me to learn how to decipher the city from below, how to perceive the \aKeyword[lived space]{space+lived space} that \aKeyword[Henri Levebfre]{henri levebfre+lived space} is talking about, that space that extends over the concrete urban space that we see, touch and feel everyday and over the symbolical urban space that recalls memories or feelings. \inright{walking asking questions}They suggested that I walk asking questions \footnote{This is a reference to the \aKeyword[Zapatistas]{zapatistas}\toTranslate[walking we ask questions]{preguntando caminamos}}.By \aKeyword[asking questions]{objectives} I determined what shape this thesis could take, methodological wise, action wise and theoretical wise. 

\spaceHalf

\inright{theoretical considerations}
\reference[methodology_whoami_actionresearch_topics]{}I comprehend people's and movement struggle in São Paulo as a critique of power structures the produce social inequalities and whose transformation and overcoming is proposed by achieving the \rightToTheCity and \accessToTheCity that is demanded and realized in many facets and flavours. Along with the demand of access and right to the city comes the demand of genuine \participation in the city's spaces, thus one's own lived spaces. As I addressed the \gotoTextMark[fragmented society earlier]{methodology_whoami_fragmentedsocialspaces}, the notion of \citizenship and the actual denial of \citizenship, of having a part as excluded parts of society, is another reason to demand genuine \participation in order to achieve access and the right to the city. That in turns means a transformation of the structures of inequality.
...
Especially during my stay in São Paulo, new \aKeyword{personal relations} have been established. Actually, it would have been impossible to write this thesis without personal relations. It was a long lasting process to establish them on a friendship base. 
...
\reference[methodology_whoami_actionresearch_engagement]{}Even though I feel sympathetic to the people and support their demands and struggles, show my solidarity and participate in their actions, I had no sufficient time to get really engaged in a continuous and structural manner in existing struggles, may they be occupations for housing or another type of transformation of the street reality, to name just a few right now.  I therefore remained somehow in an intermediate space, not really diving completely into the street reality nor staying outside as a sole observer. 

\reference[methodology_whoami_actionresearch_engagementintensity]{}I would therefore say that my thesis is not to full extend a work from an \aKeyword[activist perspective]{perspective+activist}, \aKeyword[from within]{perspective+from within}, but surely it is not about the streets from an \aKeyword[academic perspective]{perspective+academic}, even though it incorporates \aKeyword[academic knowledge]{knowledge+academic}. Probably this space I feel myself located into, is a space... 
...
% goals: relate self-determined action to the city, its spaces and places, to the cities concepts of exlusion and the self determined praxis against it
