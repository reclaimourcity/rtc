...
\startCitation
There are two ways of counting the parts of the community: The first only counts empirical parts -- actual groups defined by differences in birth, by different functions, locations, and interests that constitute the social body. The second counts 'in addition' a part of the no-part. [...]  The second counts 'in addition' a part of the no-part. We will call the first police and the second politics. [...] In this fittingness of functions, places, and ways of being, there is no place for a void. It is this exclusion of what 'there is not' that is the police-principle at the heart of statist practices \aQuoteB{Rancière}{2000}{6}
\stopCitation

What does it mean that there is no place for the \aQuoteInText{void}? Maybe a look of the aim of social struggle is helpfully. In the sense that I understand social struggle, it should lead to emancipatory social transformation by overcoming the status quo. A transformation should lead to a just society where oppressive and discriminating \powerStructures have been abolished. This in turn would mean the abolishment of the partitions, symbols, roles and functions that are structuring our being in a \aQuoteInText{world lived out of necessity}. Thus the \aQuoteInText{void} is the space emancipatory struggle is directed to, it is the space of the people where categories such as powerless and power holders, does not exists anymore.
...
What is understood as politics today is called \aQuoteInText{the police} in the thesis of \JRanciere. \aQuoteInText{The police} is not necessarily what we associate with the police on the streets \bracket{which is a part of it anyway}. 
...
I think I need a break here i order structure things and my thoughts a bit. The \aQuoteInText{void} is that space that does not exist in the efforts of the \police to \aQuoteInText{partition the sensible}, thus the world we see and feel and perceive. The \aQuoteInText{void} is the space of those that are not supposed to The \aQuoteInText{take part}. Those that are not supposed to \aQuoteInText{take part} are the poor but the poor are not the material poor or what we perceive as poor. 
...
So, the political as we know it is the \police that according to \aQuoteInTextA{Rancière} \aQuoteInText{partitions the sensible} world and denies the fact that there is a space, the \aQuoteInText{void}, where the people do not need special qualifications to rule and being ruled. 

The political then dissolves into political subjects, which are we, the \aQuoteInText{poor} that are now unheard. 

Still there are some unresolved questions for me when looking at São Paulo. 


\startARemark{den letzten teil nochmal überarbeiten} und noch nen übergang finden zu levebfre.
\stopARemark
