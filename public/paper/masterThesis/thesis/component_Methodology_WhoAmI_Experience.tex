...
I don't intend to distinguish those spaces as separate from each other, the \aKeyword[research space]{space+research} separated from the \aKeyword[social space]{space+social} which represents or is represented by the city, separated from \aKeyword[private space]{space+personal} of my life in São Paulo.  I didn't define hours per day to enter the research space, nor hours to enter the daily life or social space.  
