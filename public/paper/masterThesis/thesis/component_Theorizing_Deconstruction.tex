...
The city described by \HLefebvre is comprehensively reflected on in \aQuoteInTextT{Space, Difference, Everyday Life}, a selection of essays drowning into the realms of \sspaces. The \deconstruction of the city and its \sspaces mainly draws on those essays. The \deconstruction of urban spaces should facilitate pointing out possibilities for transforming the city into an emancipated space, a \void in the sense of \JRanciere. It could also help to understand what has been bygone urban struggles have been lacking, such as the revolts in May 68 that have been introducing this chapter.

\startCitation
In retrospect, the claims to the city/difference of “1968” functioned more as a force of capitalist modernization than as a stimulus of counterhegemony. The mobilizations ultimately failed to energize potentially counterhegemonic (urban) strategies with longer time horizons. [...] Without a capacity to transform the energies of short-term mobilization into a sustained urban strategy of transformation, differentialist claims could thus be appropriated by the state, the bourgeoisie, and urban specialists for a process of commodifying the very form of the urban as centrality/difference [...]. In this situation, oppositional strategies have counterhegemonic potential only if they transform (rather than only assert) the minimal differences of commodified festivality, multiculturalized ethnicity, and racialized suburban marginality. \aQuoteB{Kipfer}{2008}{204,205}
\stopCitation

The last two excerpts taken from \aQuoteInText{Space, Difference and Everyday Life} give hints to start deciphering the city and its spacesm, differently from viewing it just as a geographical or physical space composed of houses, streets or boundaries. What we are looking for are the apparently invisible spaces embedded in physical space. 

If we imagine the city with all its people, with all its neighbourhoods, extensions, remote areas and peripheries, then the city is \aQuoteInText{a space of encounter} of all those that life in it. This \aQuoteInText{space of encounter}\favelas reveals the social praxis and the relations among those that are entering and living in this space in everyday life. It has no specific form nor is it bounded to a particular location, 


Imagine for a moment the centre of São Paulo. What can be encountered there? 

where does an encounter does not take place or is restricted

what does it reveal

uniformisation, every space its qualified by a category, favelas, middle class area, gated community business district, social housing 

disturbances of the homogeneity of spaces is seen as an offence, it is not acceptable. 

min difference

perceived, lived, conceived spaces

montag:

- introduction, abstract, zusammenfassung, fotos
- diaries
- deconstruction
...
\startCitation
They have attempted to grasp everything that—through the subconscious submission to the naturalizing effect that results from the transformation of social space into appropriated physical space—is often attributed to the effects of physical or geographical space, but can and also must, in fact, be derived from the spatial distribution of public and private resources. In turn, the latter only represents the crystallization of the local basic unit in question (region, department, etc.) at a definite time in its history, and of its position within national space and so on. 

Once the totality of the phenomena that are apparently bound up with physical space, but in reality reflect economic and social differences, have been identified and evaluated, an attempt would have to be made to isolate the irreducible remainder that must be attributed to the genuine effect of proximity and distance in purely physical space. \aQuoteB{Prigge}{2008}{47}
\stopCitation

\startCitation
Everyday life, in a sense residual, defined by “what is left over” after all distinct, superior, specialized, structured activities have been singled out by analysis, must be defined as a totality . . . Everyday life is profoundly related to all activities, and encompasses them with all their differences and their conflicts; it is their meeting place, their bond, their common ground. \aQuoteB{}{2008}{163}
\stopCitation
...
%Commofification reveals social practice. The periphery is impacted in as much ways as the centre itself. Commodification of food \bracket{healthy or not} for instance destroys the environment in the peripheries through genetically modified crops, monoculture and the heavy use of fertilizers

%while the peripheries of the centre arecan also be conceived as the oppositions in decisions making. The centre, the inner city for instance, represents the space of decision making because there, all actors that compose society are simultaneously present and active. The centre is the space of social practice, where social practice is carried out, living, working, leisure, culture, struggle. 

%The periphery and the centre are visible on city and the global scale. Such as relationship probably means that everything is interconnected. On the city scale, such as in São Paulo, the peripheries are the former country side. Now they are the extensions of the centre.

%\aQuoteInB{}{2008}{173} 
%political knowledge and urban utopias

%\aQuoteInB{}{2008}{163} 
%Everyday life, in a sense residual, defined by “what is left over” after all distinct, superior, specialized, structured activities have been singled out by analysis, must be defined as a totality . . . Everyday life is profoundly related to all activities, and encompasses them with all their differences and their conflicts; it is their meeting place, their bond, their common ground.3
