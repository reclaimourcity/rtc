...
\setupTABLE[r][first][background=color, backgroundcolor=white, foreground=color, foregroundcolor=magenta:8]
\setupTABLE[c][1][width=1cm]
\setupTABLE[c][2][width=2cm, style=\tt\bf]
...
\bTD[background=color, backgroundcolor=white]\eTD\bTD#1:\eTD\bTD#2\eTD
\eTR
}
