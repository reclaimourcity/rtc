...
\startAReminder[nicht vergessen] das ich akademisches und movement wissen annähren und sich ergänzen lassen will. 
\stopAReminder

\startAReminder[bei partiellem wissen kann ich keine generelle theorie ausarbeiten weil die aus der summer des partiellen wissen bestehen müßte]
\stopAReminder
...
When choosing \abbrFull{AR} as \gotoTextMark[research framework]{methodology_whoami_actionresearch}, I defined that my aim of knowledge production and theorizing is neither universal validity not generalized abstraction. Thus I do not intent to formulate a general theory from the insights gained during my research actions nor do I intend to prove or adjust any existing theory. 

It would be contradictory if I consider the knowledge produced during research action(s) as partial, emerging from a particular standpoint, the standpoint of the people, my standpoint. I argued \gotoTextMark[already]{} that I narrate from a subjective position, the position of the people, the position of movements, my position, that is biased because it represents knowledge situated in the practice of struggle, that is situated in the reality of struggle, that is lacking requested objectivity and is not based on systematic surveying in order to be useful for academic purposes. 

On the other hand, I do not deny the relevance of academic theorizing, I only argue that I do not conform to follow \gotoTextMark[academic norms] of the process of theorizing and knowledge production because I consider knowledge as part of a particular social space, constructed from the standpoint of an individual or a group that is living and struggling in one space or from the standpoint of an individual or group that is living and benefiting from it. 

In São Paulo, many people are frequenting the centre of the city, the social space that the centre represents, but ones own knowledge about that space is certainly different if one is seeking a place to sleep on the streets everyday, repressed by police and institutional agents, seeking for cardboard to collect and sell or if one is frequenting the bars, the shopping malls or the office. In those few examples one encounters already different perspectives of the same social space which are resulting in the production of different knowledge of it, from ones own particular standpoint.

\startAReminder[hier ein argument von ian hacking über wissenschaft]
\stopAReminder

But coming back to the initial question. I will first take a look at the options I would have in academic terms. 
