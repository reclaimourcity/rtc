...
\reference[methodology_whoami_actionresearch_notionsoftheorizing]{}Different notions of theorizing, knowledge and content can be distinguished here, notions that are relevant for this thesis research \bracket{there are much more notions that are not considered here} which is grounded on actions conducted in a social world:
...
Having generally framed and explained the approach to \abbrFull{AR} in this thesis by now, I will derive which \aKeyword[concrete objectives]{objectives}, methods and tools are the consequences.
