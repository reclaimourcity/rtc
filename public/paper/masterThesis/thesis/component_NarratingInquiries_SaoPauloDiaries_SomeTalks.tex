...
} but also to the current \toTranslate[higienista]{cleansing} policy of the city that aims to clean the central areas \bracket{such as Sé, República or Luz} off the people in street situation by expelling and forcing them through agents of civil service and \abbr{GCM} into social institutions such as the \gotoTextMark[tendas at Parque Dom Pedro]{narratinginquiries_saopaulodiaries_dayandnight}.
...
While we are slowly walking towards \locSe and then further on to \locRepublica \Gi said:
...
Its the young guy we met back then, sitting there, close to the metro entrance of \locSe, together with a bunch of other people. We greet each other and he starts immediately:
...
%\startARemark{das ist noch überhaupt nicht gut} und muss auf jeden fall noch überarbeitet werden.\stopARemark
...
\stopPersonal
%\startARemark{wie kann die überleitung hier aussehen?} crackolândia, polizei, straße, crime?\stopARemark
...
Organized occupations are attempting to prevent such a development by defining and applying rules of conduct within their buildings. The \gotoTextMark[interview we made with people]{text mark missing interview} of a hotel occupied by \abbrNew{Frente da Luta por Moradia}{FLM} at \locAvIpiranga is bringing this matter up as well. 
...
%\startARemark{kurze erklärung von mst fehlt noch}\stopARemark
