...
{%
	\iffirstargument
		\MAR{#2}{\color[magenta:8]{\em#1}}
	\else
		\MAR{#2}{\color[magenta:8]{\em#2}}
	\fi
}
...
\placefigure[location=text]{Five main tendencies Action Research is aiming for, according to \aQuoteB{Morell}{2009}{23,24}}
{
\starttyping
...
\inright{starting to define objectives}
In this thesis, not all of those suggested tendencies are present nor do they proclaim equal shares. The experience gained in São Paulo is drawn on certain tendencies that I gather under the term of \abbrFull{AR}. I want to lay out those aspects next in order to derive the final objectives of this thesis, that will allow a concrete positioning, a concrete statement about the intention, expectation and realization of this thesis.

\spaceHalf

\inright{participative//collaborative}
\startAReminder
hier kommt der ablauf rein aber auch die festlegung welche themen eigentlich angesprochen werden, also vorallem die stadt und nicht analyse der menschen
\stopAReminder

\spaceHalf

\inright{opening knowledge means transparency and free access...}
The \refMissingSrc{self-conception} already determined that the process and outcome of this thesis is supposed to be transparent and freely accessible. Thus  \aKeyMarVi{opening knowledge} is a major objective and has been tackled by making all produced content \aKeyMarVi[instantly accessible]{knowledge - instant access}, for example on the web. Further on, the progress of the thesis can be tracked online as well. Making the progress \aKeyMarVi[transparent ]{knowledge - transparency} may also help others to understand under which conditions research was intended, what worked out, what had been adjusted, what was impossible to do and what was grounded on wrong preconceptions. 

\spaceHalf

\inright{... no intellectual property rights and open review}
Opening knowledge in this context also means that no one \aKeyMarVi[possesses ]{knowledge - expropriated} the right to own and monetize the formulated knowledge, the thesis and the produced content. These information are supposed to benefit all and to allow reproduction and reuse under similar terms. This could also lead to a facilitation of the formulation of \aKeyMarVi[critique]{knowledge - critique} and \aKeyMarVi[reflection ]{knowledge - reflection} because one must not be privileged to access knowledge or to return a critique.

\spaceHalf

\inright{... international exchange, translations and free sources}
Another important point is the fact that I went abroad for this thesis. Back at home, only opening knowledge, \aKeyMarVi[sharing]{knowledge - shared} it freely, has the potential that those with whom I stayed together can spot, utilize and criticise it. Opening knowledge means also \aKeyMarVi[translating]{knowledge - translations} into Portuguese but also to use a language that is understandable \bracket{which may the hardest part}. It also means that all \bracket{or the majority at least} external references I use, cite and refer to, must be \aKeyMarVi[accessible]{knowledge - open sources} to allow to inspect them as well and to autonomously make up one's own mind instead of relying on my \bracket{biased} interpretations.

\spaceHalf

\inright{producing alternative content...}
The production of alternative content is an immanent objective to this thesis, even though it is not its main perspective. If alternative content is understood as movement content that formulates own standpoints, apart from academic papers and publishing, in flyers, zines, videos or music, I would partly consider this thesis still as alternative. From my perspective, this thesis is a means of the struggle of the movement, thus it shall benefit movement theorizing in the sense that it provides access to \bracket{academic} knowledge that is normally not accessible to non-academics.

Access to academic theorizing can help to further strengthen own positions as argued \refMissingSrc{elsewhere} by understanding which discourses are actually hold by those that are opposed, on which arguments those discourses are drawn on. An example could be participation and right to city issues that are already visible in many movement and official discourses in São Paulo, as we will see later on.  

Another aspect, the thesis form, is certainly more rooted in the usual academic frame. At the end it will become a master thesis. However, the online publication of the thesis process and the final results for example are forms of alternative content because there, all kinds of media are gathered and are open accessible, such as videos, diaries or photos. They will find their way into the written thesis to a certain extend as well. Here, no limits in the creation of alternative content are set, just as well as in the usage of existing content such as journals published by street people, handouts or readers. 

By perceiving this thesis as part of the struggle of the people, a further intention would be to inject movement content in academic discourse. It has been already argued \refMissingSrc{elsewhere} that movement theorizing is not less relevant than academic theorizing and that the produced content could help to overcome or converge the borderlines between those very different spaces.

\spaceHalf

\inright{building relations...}
Especially during the stay in São Paulo, different personal relations have been build. Actually it would have been impossible to write this thesis without personal relations. It has been difficult and was a long lasting process to establish them on a friendship base. 

In fact, reflecting about the time in the city, personal relations led to contact with various movements and collectives. There has been no single movement nor a single person I collaborated with but a wide variety all grounded on the streets. Therefore I cannot claim that a certain movements position is reflected by this thesis. Movements and collectives where often also bound to particular spaces in the city. Thus besides relations to people and their movements, relations to people and their spaces has been established as well. This interrelation to spaces in the city is one important aspect for the organization of the people. Among others I experienced movements and collectives such as \refMissingSrc{MNPR} or \refMissingSrc{aRuaca} but had several references points in the city as well, at \refMissingSrc{OCAS} or \refMissingSrc{AyCarmela} for instance. 

Further networking beyond the time of the thesis is intended, especially for the distribution of knowledge about the situation in São Paulo but also for the expression of solidarity. The question of networking remains to be seen, its an aim for the time after the thesis complete finalization. We could then think about conducing self-organized information events or such alike.
