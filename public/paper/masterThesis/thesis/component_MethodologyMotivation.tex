...
\textBoxedRoundMax[0.4]{... an attempt to avoid to represent anybody thus avoid hierarchies. I want to be together with the people and experience myself what they are experiencing.}
\textBoxedRoundMax[0.4]{... an attempt to avoid to keep information that has been given to me just in the closed academic circle.}
...
\textBoxedRoundMax[0.4]{thus, I prefer to evoke an reaction and not just a sole analytical and systematically sound reproduction of \bracket{the} \quote{reality}.}
\textBoxedRoundMax[0.4]{... an attempt to decouple the question of relevance of the research action(s) from the \bracket{western} scientific norm of being innovative, subjective and systematic,}
\textBoxedRoundMax[0.4]{ thus, I prefer to work qualitative and event driven instead of systematic and quantitative}
\spaceHalf
